...
from intrinseca.core.kernel import segment_events_kernel, verify_nopython_mode, warmup_kernel
from intrinseca.core.state import DCState, create_empty_state, load_state, save_state
...
class TestEngine:
    ...
    def test_engine_creation(self, tmp_silver_path):
        ...
        engine = Engine(theta=0.01, silver_base_path=tmp_silver_path)
    ...
    def test_engine_warmup(self, tmp_silver_path):
        ...
        # warmup=True pre-compila el kernel durante la creación
        engine = Engine(theta=0.01, silver_base_path=tmp_silver_path, warmup=True)
...
class TestIntegration:
    ...
    def test_multi_day_processing(self, tmp_silver_path):
        ...
        # Crear datos para 3 días con timestamps correctos
        days_data = []
